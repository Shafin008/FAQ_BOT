...
st.write("1. Enter your required API keys in the section below")
st.write("2. Upload PDF file(s) using the file uploader")
st.write("3. Click 'Start Engine' to process your document")
st.write("4. Ask questions about the content of your PDF(s)")
